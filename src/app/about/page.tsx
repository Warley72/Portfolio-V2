    ...
    return(
        <div className="bg-zinc-950 text-white p-[3rem]">
            ...
            <Card className="p-6 bg-zinc-950 border border-white/20 mt-8">
                ...
                <div>
                    <Button className="bg-transparent text-[#A1A1AA] cursor-pointer hover:bg-[#222224] hover:text-white transition duration-300">
                        Show previous roles
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="m6 9 6 6 6-6"></path></svg>  
                    </Button>
                </div>
            </Card>
        </div>
